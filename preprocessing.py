...
subdirectories = ['SM02', 'SM06', 'SM09', 'SM19', 'SM37', 'SM39', 'SM40']
...
for subdirectory in subdirectories:
    ...
    parent_subdirectory = os.path.join(output_parent_dir, f'{subdirectory}_preprocessing')
    ...
    for sub_subdirectory in sub_subdirectories:
        ...
        sub_subdirectory_path = os.path.join(parent_subdirectory, sub_subdirectories)

        # creating the corresponding output directory
        output_directory = os.path.join(sub_subdirectory_path)

    # Use glob to find all files with a specific extension (e.g., .mseed) in the subdirectory.
    data_files = glob.glob(os.path.join(subdirectory_path, ))
    ...
    for data_file in data_files:
        ...
        # Define the output file path and save the preprocessed Stream.
        output_file = os.path.join(output_subdirectory, os.path.basename(data_file))
